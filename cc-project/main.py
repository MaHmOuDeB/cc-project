...
async def retrieve_data(ticker:str):
    ...
    if search_term in df['Company'].values:
        print(f"{search_term} is found in the file.")
    else:
        print(f"{search_term} is not found in the file.")
...
##Find file
##rest api is not working in the credits section.